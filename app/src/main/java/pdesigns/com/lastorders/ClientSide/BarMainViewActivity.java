 ...
 */
public class BarMainViewActivity extends AppCompatActivity {
...
// Session Manager Class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Bar Information"));
        ...
        final BarPagerView adapter = new BarPagerView
